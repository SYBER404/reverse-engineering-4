#coded by: RED-MAFIA
# Time Succes coded : 2022-03-26 18:16:47.173597
#!/usr/bin/python3
#coding=utf-8
...
{P}[•]{B}--------------------------------------------------------------------{P}[•]
{B} |
{P}[•]{B}-----> {P}AUTHOR : {B}RED-MAFIA {P}RIAZKHAN
{P}[•]{B}-----> {P}GITHUB : {B}https://github.com/Red-Mafia
{P}[•]{B}-----> {p}FACBOOK : {B}RED-MAFIA
{B} |""")
...
komtwol = random.choice(['ANJAY SLEMEX LORD JEECK X NANO ', 'RED-MAFIA X NANO', 'BANH KOK LO JAGO BANGET SIH ', 'LORD DAH MAKAN BLM'])
